...
<div class="wrapper">
    <header class="main-header">
        ...
        <a class="logo">
            <span class="logo-lg">CoursePlus</span>
        </a>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <div class="content-header-right">
                <a href="${pageContext.request.contextPath}/router" class="btn btn-primary btn-sm">View
                    All</a>
            </div>
        </section>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form action="${pageContext.request.contextPath}/router/update/${router.id}" class="form-horizontal" method="post">
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label  class="col-sm-3 control-label">Tên <span>*</span></label>
                                    <div class="col-sm-4">
                                        <input value="${router.name}" type="text" class="form-control" name="name">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Quãng đường <span>*</span></label>
                                    <div class="col-sm-4">
                                        <input value="${router.distance}" type="text" class="form-control" name="distance">
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label  class="col-sm-3 control-label">Số điểm dừng<span>*</span></label>
                                    <div class="col-sm-4">
                                        <input value="${router.stopPoint}" type="text" class="form-control" name="stopPoint">
                                    </div>
                                </div>
