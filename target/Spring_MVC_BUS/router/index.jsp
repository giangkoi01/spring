    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <div class="content-header-right">
                <a href="${pageContext.request.contextPath}/router/create" class="btn btn-primary btn-sm">Add
                    New</a>
            </div>
        </section>
                        ...
                        <div class="box-body table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="router" items="${listRouter}">
                                    <tr>
                                        <td>${router.name}</td>
                                        <td>${router.distance}</td>
                                        <td>${router.stopPoint}</td>

                                        <td>
                                            <a href="${pageContext.request.contextPath}/router/update/${router.id}"
                                               class="btn btn-primary btn-xs">Edit</a>
                                            <a href="${pageContext.request.contextPath}/router/delete/${router.id}"
