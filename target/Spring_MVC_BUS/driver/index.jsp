    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <div class="content-header-right">
                <a href="${pageContext.request.contextPath}/driver/create" class="btn btn-primary btn-sm">Add
                    New</a>
            </div>
        </section>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="driver" items="${listDriver}">
                                    <tr>
                                        ...
                                        <td>${driver.level_driver}</td>

                                        <td>
                                            <a href="${pageContext.request.contextPath}/driver/update/${driver.id}"
                                               class="btn btn-primary btn-xs">Edit</a>
                                            <a href="${pageContext.request.contextPath}/driver/delete/${driver.id}"
