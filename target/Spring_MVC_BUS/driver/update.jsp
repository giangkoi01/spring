...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="treeview ">
                    <a href="#">
                        <i class="fa fa-usd"></i> <span>Product</span>
                    </a>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form action="${pageContext.request.contextPath}/driver/update/${driver.id}" class="form-horizontal" method="post">
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label  class="col-sm-3 control-label">Tên <span>*</span></label>
                                    <div class="col-sm-4">
                                        <input value="${driver.name}" type="text" class="form-control" name="name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input value="${driver.address}" type="text" class="form-control" name="address">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input value="${driver.phoneNumber}" type="text" class="form-control" name="phoneNumber">
                                    </div>
                                </div>
